...
test_info float_test_info [] =
{
  ...
  { "HYSCAN_DATA_UINT8",    HYSCAN_DATA_UINT8,     0.0, 1.0, 1.0 / 256.0 },
  { "HYSCAN_DATA_UINT16",   HYSCAN_DATA_UINT16,    0.0, 1.0, 1.0 / 16384.0 },
  { "HYSCAN_DATA_UINT32",   HYSCAN_DATA_UINT32,    0.0, 1.0, 2.0 / 16777216.0 },
  { "HYSCAN_DATA_FLOAT",    HYSCAN_DATA_FLOAT,     0.0, 1.0, 0.0 },
  { "HYSCAN_DATA_NORMAL8",  HYSCAN_DATA_NORMAL8,   0.0, 1.0, 2.0 / 64.0 },
  { "HYSCAN_DATA_NORMAL16", HYSCAN_DATA_NORMAL16,  0.0, 1.0, 2.0 / 8192.0 }
};
...
test_info complex_float_test_info [] =
{
  ...
  { "HYSCAN_DATA_COMPLEX_UINT8",    HYSCAN_DATA_COMPLEX_UINT8,     0.0, 1.0, 2.0 / 256.0 },
  { "HYSCAN_DATA_COMPLEX_UINT16",   HYSCAN_DATA_COMPLEX_UINT16,    0.0, 1.0, 2.0 / 16384.0 },
  { "HYSCAN_DATA_COMPLEX_UINT32",   HYSCAN_DATA_COMPLEX_UINT32,    0.0, 1.0, 2.0 / 16777216.0 },
