 ...
 *
 * Класс предназначен для описания схемы данных. Под схемой данных подразумевается
 ...
 *
 * Параметры могут быть объединены в узлы. Узлы могут включать другие узлы.
 * Идентификатор параметра состоит из всех идентификаторов узлов, в которых
 * он находится, разделённых символом '/'. Корневой узел схемы имеет путь '/'.
 * Идентификаторы состоят из символов латинского алфивита, цифр, точек, тире
