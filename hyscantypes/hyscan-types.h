 ...
 * борт, ось Z вниз. Для надводных судов, вертикальное смещение необходимо
 * указывать относительно действующей ватерлинии. Для подводных аппаратов
 * можно выбрать любую базовую точку.
 *
